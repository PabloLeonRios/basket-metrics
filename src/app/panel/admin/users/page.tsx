...
export default function AdminUserManagementPage() {
    ...
    const handleToggleUserStatus = (targetUser: UserFromAPI) => {
        ...
        if (!confirm(`¿Seguro que quieres ${actionText} al usuario ${targetUser.name}?`)) return;
        
        handleUpdateUser(targetUser._id, { isActive: newStatus }, `Usuario ${actionText}do.`);
    };

    const handleTeamChange = (e: ChangeEvent<HTMLSelectElement>, userId: string) => {
    ...
    return (
        <main className="flex-1 p-4 md:p-6 lg:p-8">
            <header className="mb-6">
                ...
                <p className="mt-1 text-sm text-gray-500">Activa/desactiva cuentas y asigna usuarios a equipos.</p>
            </header>
