  ...
  return (
    <div className="w-full max-w-lg mx-auto aspect-[100/94] touch-none relative overflow-hidden rounded-lg shadow-2xl border-4 border-gray-800 dark:border-gray-900">
      ...
      >
        ...
        {shotCoordinates && (
          <g>
            <circle cx={shotCoordinates.x} cy={shotCoordinates.y} r="1.5" fill="#EF4444" stroke="#FFF" strokeWidth="0.5" className="animate-ping absolute" />
            <circle cx={shotCoordinates.x} cy={shotCoordinates.y} r="1.5" fill="#EF4444" stroke="#FFF" strokeWidth="0.5" />
          </g>
        )}
      </svg>
    </div>
